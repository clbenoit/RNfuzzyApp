...
[TCC](https://www.ncbi.nlm.nih.gov/pubmed/23837715) package provides functions to perform differential expression analysis from RNA-seq count data. The normalization strategy called DEGES is essential for noramlization accuracy.
...
- [DESeq2](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4302049/) : uses shrinkage estimation for dispersions and fold changes to improve stability and interpretability of estimates. This enables a more quantitative analysis focused on the strength rather than the mere presence of differential expression. 
